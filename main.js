...
allImages.forEach((img, index) => {
  ...
  // Avoid forcing hundreds of eager image decodes on mobile portfolio pages.
  if (isPortfolioPage && isSmallViewport) {
...
if (isPortfolioPage) {
  ...
  // Mobile safe mode: skip heavy image-tracking loader logic.
  if (isSmallViewport) {
    if (pageLoader) {
    ...
    if (pageLoader) {
      ...
      // Failsafe: never let loader block page forever.
